...
<body class="bg-gray-100 text-gray-800">
    ...
    <!-- Hero Section -->
    <section class="relative bg-cover bg-center" style="background-image: url('<?php echo $base_url; ?>/assets/images/landingPage_2.png'); height: 80vh;">
        ...
        <div class="relative container mx-auto text-center text-white flex flex-col justify-center h-full">
            ...
            <div class="mt-6">
                <a href="<?php echo $base_url; ?>/views/auth/login.php" class="bg-green-600 hover:bg-green-500 text-white py-3 px-6 rounded-lg mr-4">Get Started</a>
                <a href="<?php echo $base_url; ?>/views/auth/register.php" class="bg-white text-green-600 hover:text-white hover:bg-green-500 border border-green-600 py-3 px-6 rounded-lg">Join Us</a>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto text-center">
            ...
            <div class="mt-10 grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-100 p-8 rounded-lg shadow-md hover:shadow-lg transition duration-300 ease-in-out transform hover:-translate-y-2">
                    <img src="<?php echo $base_url; ?>/assets/images/report_issues.png" alt="Report Issues" class="mx-auto h-24 w-24">
                ...
                <!-- Feature 2 -->
                <div class="bg-gray-100 p-8 rounded-lg shadow-md hover:shadow-lg transition duration-300 ease-in-out transform hover:-translate-y-2">
                    <img src="<?php echo $base_url; ?>/assets/images/proposed_solution.png" alt="Propose Solutions" class="mx-auto h-24 w-24">
                ...
                <!-- Feature 3 -->
                <div class="bg-gray-100 p-8 rounded-lg shadow-md hover:shadow-lg transition duration-300 ease-in-out transform hover:-translate-y-2">
                    <img src="<?php echo $base_url; ?>/assets/images/track_progress.png" alt="Track Progress" class="mx-auto h-24 w-24">
    ...
    <section class="py-16 bg-green-600 text-white">
        <div class="container mx-auto text-center">
            ...
            <div class="mt-6">
                <a href="<?php echo $base_url; ?>/views/auth/register.php" class="bg-white text-green-600 hover:text-white hover:bg-green-500 border border-white py-3 px-6 rounded-lg">Register Now</a>
            </div>
        </div>
    </section>
